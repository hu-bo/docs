...
export interface ApiAccessRequestAccessRequest
  ...
  attributes: {
    ...
    requestedPerm: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 64;
      }>;
    ...
    targetId: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['SPACE', 'DOC']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDocUserActivityDocUserActivity
  ...
  info: {
    ...
    singularName: 'doc-user-activity';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiDocDoc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accessMode: Schema.Attribute.Enumeration<
      ['OPEN_EDIT', 'OPEN_READONLY', 'WHITELIST_ONLY']
    > &
      Schema.Attribute.DefaultTo<'OPEN_READONLY'>;
...
export interface ApiSpaceFolderSpaceFolder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visibilityScope: Schema.Attribute.Enumeration<['ALL', 'DEPT_ONLY']> &
...
export interface ApiSpaceSpace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ctime: Schema.Attribute.DateTime;
    datasetId: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
      }>;
...
export interface ApiUserSpaceAuthUserSpaceAuth
  ...
  info: {
    ...
    singularName: 'user-space-auth';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    canCreateDoc: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    canCreateFolder: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    canRead: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctime: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::doc-space-acl.doc-space-acl': ApiDocSpaceAclDocSpaceAcl;
      'api::doc-user-acl.doc-user-acl': ApiDocUserAclDocUserAcl;
      'api::doc-user-activity.doc-user-activity': ApiDocUserActivityDocUserActivity;
      'api::doc.doc': ApiDocDoc;
      'api::space-dept.space-dept': ApiSpaceDeptSpaceDept;
      'api::space-folder.space-folder': ApiSpaceFolderSpaceFolder;
      'api::space.space': ApiSpaceSpace;
      'api::user-space-auth.user-space-auth': ApiUserSpaceAuthUserSpaceAuth;
